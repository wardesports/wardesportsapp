...
ActiveRecord::Schema.define(version: 20171027010952) do
  ...
  create_table "event_games", force: :cascade do |t|
    t.integer "user_id"
    t.integer "group_id"
    t.index ["group_id"], name: "index_event_games_on_group_id", using: :btree
    t.index ["user_id"], name: "index_event_games_on_user_id", using: :btree
  end
  ...
  add_foreign_key "event_games", "groups"
  add_foreign_key "event_games", "users"
